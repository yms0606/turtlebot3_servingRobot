...
static const _ServingStatus_Request_type_support_symbol_names_t _ServingStatus_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, serving_interface, srv, ServingStatus_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, serving_interface, srv, ServingStatus_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, serving_interface, srv, ServingStatus_Request)() {
  return &::serving_interface::srv::rosidl_typesupport_c::ServingStatus_Request_message_type_support_handle;
}
...
static const _ServingStatus_Response_type_support_symbol_names_t _ServingStatus_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, serving_interface, srv, ServingStatus_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, serving_interface, srv, ServingStatus_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, serving_interface, srv, ServingStatus_Response)() {
  return &::serving_interface::srv::rosidl_typesupport_c::ServingStatus_Response_message_type_support_handle;
}
...
static const _ServingStatus_type_support_symbol_names_t _ServingStatus_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, serving_interface, srv, ServingStatus)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, serving_interface, srv, ServingStatus)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, serving_interface, srv, ServingStatus)() {
  return &::serving_interface::srv::rosidl_typesupport_c::ServingStatus_service_type_support_handle;
}
